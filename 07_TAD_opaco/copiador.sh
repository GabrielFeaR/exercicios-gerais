...
dest_dir="TAD_opac_" #<coloca o radical da atividade aqui, no diretorio 05_ponteiros seria "pont_"
output_dir="Respostas/Gabriel" #<coloca seu nome aqui
main_file="main.c"

# Define the range of destination directories (em quais exercicios vao ser criados o Respostas/nome)
start_dest=00 
end_dest=19 #coloca a quantidade de atividades
#################################################################################################
